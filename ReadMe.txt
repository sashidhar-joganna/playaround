...
The results of the tests are published using a free trial software tesults. We can also see the temporary test results files under the test folder ()
...
THe APIs are all automated using Postman for CRUD operations on Pet Object
    ...
    - Find Pet by ID
    - Delete Pet by ID
See the scripts for postman in folder "Postman Collections" with test validations done on the responses for these API calls 